...
#root_category = Category.create(title: 'Sedan', icon: 'settings', published: true, tag: 0)
...
#  end
#end
AdminUser.create!(email: 'chau.le8888@gmail.com', password: 'adminshop', password_confirmation: 'adminshop')
